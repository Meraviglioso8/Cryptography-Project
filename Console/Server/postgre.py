...
try:
    ...
    insert_values = [("mera",ph.hash("mera"),str(encrypt("harukasociu2308@gmail.com")),"normal",str(encrypt("37fceec33bbdacf998c57171d230fa9e"))), ("kizme",ph.hash("kizme"),str(encrypt("kietngo255@gmail.com")),"normal",str(encrypt("9f8ba164ed55fe5e2b77c4d4b028e0b3"))), ("tlhung",ph.hash("tlhung")," ","normal",str(encrypt("236919a82f2eab4e4eb5fe76d8f7844f")))]
    for i in insert_values:
        cur.execute(insert_script,i)
